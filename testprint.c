...
//		targetnode stack b %d  | push_cost %d   |" ,data->data, data->index, 
//		data->target->data, data->push_cost);
...
// {
// 	ft_printf("data: %d | index:  %d  ||  targetnode in b %d | 
//		pushcost a %d " ,data->data, data->index , data->target->data , 
//			data->push_cost);
// 	if (!(data->above_median))
// 		ft_printf("above_median false | \n");
// 	if (data->above_median)
...
// {
// 	ft_printf("data: %d | index:  %d  ||  targetnode in a %d | 
//		pushcost a %d " ,data->data, data->index , data->target->data ,
//			 data->push_cost);
// 	if (!(data->above_median))
// 		ft_printf("above_median false | \n");
